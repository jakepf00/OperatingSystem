...
// Notifies the device that there is a new request. 'desc_index' is the index of
// the descriptor of the new request
...
struct process *create_process(const void *image, size_t image_size) {
  ...
  // Stack callee-saved registers. These registers will be restored in the first
  // context switch in switch_context
